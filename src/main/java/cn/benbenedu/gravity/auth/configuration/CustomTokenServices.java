...
/**
 * Ref org.springframework.security.oauth2.provider.token.DefaultTokenServices
 */
public class CustomTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        ...
        if (existingAccessToken != null) {
            if (accessTokenShouldRenew(existingAccessToken)) {
    ...
    private boolean accessTokenShouldRenew(OAuth2AccessToken accessToken) {

        final var expiration = accessToken.getExpiration();
        if (expiration == null) {
            return false;
        }
        ...
        return now.getTime() >=
                expiration.getTime() - ACCESS_TOKEN_PRE_RENEW_SPAN * 1000;
    }
}
